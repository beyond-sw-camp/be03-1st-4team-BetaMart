...
INSERT INTO customer(user_id, name, password, tel, age, gender) values('jang4952', '장준혁', 'Passw0rd', '010-3748-5573', 25, 'M');

-- 중복된 전화번호를 사용하여 고객 추가: 중복 데이터를 사용하여 고객 레코드 추가 시도
INSERT INTO customer(user_id, name, password, tel, age, gender) values('jang4953', '장준혁', 'password', '010-3748-5573', 26, 'W');
